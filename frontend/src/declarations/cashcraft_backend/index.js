...
import { idlFactory } from './cashcraft_backend.did.js';
export { idlFactory } from './cashcraft_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NEXT_PUBLIC_CANISTER_ID_CASHCRAFT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cashcraft_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cashcraft_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cashcraft_backend.did.js")._SERVICE>}
 */
export const cashcraft_backend = createActor;
