...
import { idlFactory } from './wallets_backend_backend.did.js';
export { idlFactory } from './wallets_backend_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NEXT_PUBLIC_CANISTER_ID_WALLETS_BACKEND_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wallets_backend_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wallets_backend_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wallets_backend_backend.did.js")._SERVICE>}
 */
export const wallets_backend_backend = createActor;
