...
import { idlFactory } from './wallets_backend_frontend.did.js';
export { idlFactory } from './wallets_backend_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WALLETS_BACKEND_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wallets_backend_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wallets_backend_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wallets_backend_frontend.did.js")._SERVICE>}
 */
export const wallets_backend_frontend = createActor(canisterId);
