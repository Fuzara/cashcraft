...
import { idlFactory } from './cashcraft_frontend.did.js';
export { idlFactory } from './cashcraft_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CASHCRAFT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cashcraft_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cashcraft_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cashcraft_frontend.did.js")._SERVICE>}
 */
export const cashcraft_frontend = createActor(canisterId);
